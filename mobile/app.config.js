...
const runtimeVersion = 10; // Increase by 1 every time your update requires a new native build
...
export default {
  expo: {
    ...
    ios: {
      ...
      associatedDomains: [
        `applinks:canopy-git-dev-novaforgood.vercel.app`,
        `applinks:*.joincanopy.org`,
      ],
    },
    android: {
